...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2018-01-31")
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
  ...
  private static final org.apache.thrift.protocol.TField DEVICE_RESOURCES_FIELD_DESC = new org.apache.thrift.protocol.TField("device_resources", org.apache.thrift.protocol.TType.MAP, (short)6);
  ...
  public Map<ExecutorInfo,NodeInfo> executor_node_port; // optional
  public Map<ExecutorInfo,Long> executor_start_time_secs; // optional
  public Map<NodeInfo,WorkerResources> worker_resources; // optional
  public Map<NodeInfo,Double> device_resources; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    DEVICE_RESOURCES((short)6, "device_resources");
  ...
  private static final _Fields optionals[] = {_Fields.NODE_HOST,_Fields.EXECUTOR_NODE_PORT,_Fields.EXECUTOR_START_TIME_SECS,_Fields.WORKER_RESOURCES,_Fields.DEVICE_RESOURCES};
  ...
  static {
    ...
    tmpMap.put(_Fields.DEVICE_RESOURCES, new org.apache.thrift.meta_data.FieldMetaData("device_resources", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP,
                    new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, NodeInfo.class),
  ...
  public Assignment() {
    ...
    this.executor_node_port = new HashMap<ExecutorInfo,NodeInfo>();

    this.executor_start_time_secs = new HashMap<ExecutorInfo,Long>();

    this.worker_resources = new HashMap<NodeInfo,WorkerResources>();

    this.device_resources = new HashMap<NodeInfo,Double>();
  ...
  public Assignment(Assignment other) {
    ...
    if (other.is_set_executor_node_port()) {
      Map<ExecutorInfo,NodeInfo> __this__executor_node_port = new HashMap<ExecutorInfo,NodeInfo>(other.executor_node_port.size());
      for (Map.Entry<ExecutorInfo, NodeInfo> other_element : other.executor_node_port.entrySet()) {

        ExecutorInfo other_element_key = other_element.getKey();
        NodeInfo other_element_value = other_element.getValue();

        ExecutorInfo __this__executor_node_port_copy_key = new ExecutorInfo(other_element_key);
    ...
    if (other.is_set_executor_start_time_secs()) {
      Map<ExecutorInfo,Long> __this__executor_start_time_secs = new HashMap<ExecutorInfo,Long>(other.executor_start_time_secs.size());
      for (Map.Entry<ExecutorInfo, Long> other_element : other.executor_start_time_secs.entrySet()) {

        ExecutorInfo other_element_key = other_element.getKey();
        Long other_element_value = other_element.getValue();

        ExecutorInfo __this__executor_start_time_secs_copy_key = new ExecutorInfo(other_element_key);
    ...
    if (other.is_set_device_resources()) {
      Map<NodeInfo,Double> __this__device_resources = new HashMap<NodeInfo,Double>(other.device_resources.size());
      for (Map.Entry<NodeInfo, Double> other_element : other.device_resources.entrySet()) {

        NodeInfo other_element_key = other_element.getKey();
        Double other_element_value = other_element.getValue();

        NodeInfo __this__device_resources_copy_key = new NodeInfo(other_element_key);

        Double __this__device_resources_copy_value = other_element_value;

        __this__device_resources.put(__this__device_resources_copy_key, __this__device_resources_copy_value);
      }
      this.device_resources = __this__device_resources;
    }
  }
  ...
  public void put_to_executor_node_port(ExecutorInfo key, NodeInfo val) {
  ...
  public Map<ExecutorInfo,NodeInfo> get_executor_node_port() {
    return this.executor_node_port;
  }

  public void set_executor_node_port(Map<ExecutorInfo,NodeInfo> executor_node_port) {
  ...
  public void put_to_executor_start_time_secs(ExecutorInfo key, long val) {
  ...
  public Map<ExecutorInfo,Long> get_executor_start_time_secs() {
    return this.executor_start_time_secs;
  }

  public void set_executor_start_time_secs(Map<ExecutorInfo,Long> executor_start_time_secs) {
  ...
  public int get_device_resources_size() {
    return (this.device_resources == null) ? 0 : this.device_resources.size();
  }

  public void put_to_device_resources(NodeInfo key, double val) {
    if (this.device_resources == null) {
      this.device_resources = new HashMap<NodeInfo,Double>();
    }
    this.device_resources.put(key, val);
  }

  public Map<NodeInfo,Double> get_device_resources() {
    return this.device_resources;
  }

  public void set_device_resources(Map<NodeInfo,Double> device_resources) {
    this.device_resources = device_resources;
  }

  public void unset_device_resources() {
    this.device_resources = null;
  }

  /** Returns true if field device_resources is set (has been assigned a value) and false otherwise */
  public boolean is_set_device_resources() {
    return this.device_resources != null;
  }

  public void set_device_resources_isSet(boolean value) {
    if (!value) {
      this.device_resources = null;
    }
  }
    ...
    switch (field) {
      ...
      case EXECUTOR_NODE_PORT:
        if (value == null) {
          ...
          set_executor_node_port((Map<ExecutorInfo,NodeInfo>)value);
        }
        break;
      ...
      case EXECUTOR_START_TIME_SECS:
        if (value == null) {
          ...
          set_executor_start_time_secs((Map<ExecutorInfo,Long>)value);
        }
        break;
      ...
      case DEVICE_RESOURCES:
        if (value == null) {
          unset_device_resources();
        } else {
          set_device_resources((Map<NodeInfo,Double>)value);
        }
        break;
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
      ...
      case DEVICE_RESOURCES:
        return is_set_device_resources();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(Assignment that) {
    ...
    boolean this_present_device_resources = true && this.is_set_device_resources();
    boolean that_present_device_resources = true && that.is_set_device_resources();
    if (this_present_device_resources || that_present_device_resources) {
      if (!(this_present_device_resources && that_present_device_resources))
        return false;
      if (!this.device_resources.equals(that.device_resources))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_device_resources = true && (is_set_device_resources());
    list.add(present_device_resources);
    if (present_device_resources)
      list.add(device_resources);
  ...
  public int compareTo(Assignment other) {
    ...
    lastComparison = Boolean.valueOf(is_set_device_resources()).compareTo(other.is_set_device_resources());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_device_resources()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.device_resources, other.device_resources);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (is_set_device_resources()) {
      if (!first) sb.append(", ");
      sb.append("device_resources:");
      if (this.device_resources == null) {
        sb.append("null");
      } else {
        sb.append(this.device_resources);
      }
      first = false;
    }
    sb.append(")");
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<ExecutorInfo,NodeInfo>(2*_map552.size);
                ExecutorInfo _key553;
                NodeInfo _val554;
                for (int _i555 = 0; _i555 < _map552.size; ++_i555)
                {
                  _key553 = new ExecutorInfo();
                  _key553.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_start_time_secs = new HashMap<ExecutorInfo,Long>(2*_map556.size);
                ExecutorInfo _key557;
                long _val558;
                for (int _i559 = 0; _i559 < _map556.size; ++_i559)
                {
                  _key557 = new ExecutorInfo();
                  _key557.read(iprot);
                  _val558 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key557, _val558);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.worker_resources = new HashMap<NodeInfo,WorkerResources>(2*_map560.size);
                NodeInfo _key561;
                WorkerResources _val562;
                for (int _i563 = 0; _i563 < _map560.size; ++_i563)
                {
                  _key561 = new NodeInfo();
                  _key561.read(iprot);
                  _val562 = new WorkerResources();
                  _val562.read(iprot);
                  struct.worker_resources.put(_key561, _val562);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.device_resources = new HashMap<NodeInfo,Double>(2*_map564.size);
                NodeInfo _key565;
                double _val566;
                for (int _i567 = 0; _i567 < _map564.size; ++_i567)
                {
                  _key565 = new NodeInfo();
                  _key565.read(iprot);
                  _val566 = iprot.readDouble();
                  struct.device_resources.put(_key565, _val566);
                }
                iprot.readMapEnd();
              }
              struct.set_device_resources_isSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, struct.executor_node_port.size()));
            for (Map.Entry<ExecutorInfo, NodeInfo> _iter569 : struct.executor_node_port.entrySet())
            {
              _iter569.getKey().write(oprot);
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.I64, struct.executor_start_time_secs.size()));
            for (Map.Entry<ExecutorInfo, Long> _iter570 : struct.executor_start_time_secs.entrySet())
            {
              _iter570.getKey().write(oprot);
      ...
      if (struct.worker_resources != null) {
        if (struct.is_set_worker_resources()) {
          oprot.writeFieldBegin(WORKER_RESOURCES_FIELD_DESC);
          {
            ...
            for (Map.Entry<NodeInfo, WorkerResources> _iter571 : struct.worker_resources.entrySet())
            {
      ...
      if (struct.device_resources != null) {
        if (struct.is_set_device_resources()) {
          oprot.writeFieldBegin(DEVICE_RESOURCES_FIELD_DESC);
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.DOUBLE, struct.device_resources.size()));
            for (Map.Entry<NodeInfo, Double> _iter572 : struct.device_resources.entrySet())
            {
              _iter572.getKey().write(oprot);
              oprot.writeDouble(_iter572.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<ExecutorInfo, NodeInfo> _iter574 : struct.executor_node_port.entrySet())
          {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<ExecutorInfo, Long> _iter575 : struct.executor_start_time_secs.entrySet())
          {
      ...
      if (struct.is_set_worker_resources()) {
        {
          ...
          for (Map.Entry<NodeInfo, WorkerResources> _iter576 : struct.worker_resources.entrySet())
          {
            _iter576.getKey().write(oprot);
            _iter576.getValue().write(oprot);
          }
        }
      }
      if (struct.is_set_device_resources()) {
        {
          oprot.writeI32(struct.device_resources.size());
          for (Map.Entry<NodeInfo, Double> _iter577 : struct.device_resources.entrySet())
          {
            _iter577.getKey().write(oprot);
            oprot.writeDouble(_iter577.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.node_host = new HashMap<String,String>(2*_map578.size);
          String _key579;
          String _val580;
          for (int _i581 = 0; _i581 < _map578.size; ++_i581)
          {
            ...
            struct.node_host.put(_key579, _val580);
          }
        }
        struct.set_node_host_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map582 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<ExecutorInfo,NodeInfo>(2*_map582.size);
          ExecutorInfo _key583;
          NodeInfo _val584;
          for (int _i585 = 0; _i585 < _map582.size; ++_i585)
          {
            _key583 = new ExecutorInfo();
            _key583.read(iprot);
            _val584 = new NodeInfo();
            _val584.read(iprot);
            struct.executor_node_port.put(_key583, _val584);
          }
        }
        struct.set_executor_node_port_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map586 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<ExecutorInfo,Long>(2*_map586.size);
          ExecutorInfo _key587;
          long _val588;
          for (int _i589 = 0; _i589 < _map586.size; ++_i589)
          {
            _key587 = new ExecutorInfo();
            _key587.read(iprot);
            _val588 = iprot.readI64();
            struct.executor_start_time_secs.put(_key587, _val588);
          }
        }
        struct.set_executor_start_time_secs_isSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map590 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.worker_resources = new HashMap<NodeInfo,WorkerResources>(2*_map590.size);
          NodeInfo _key591;
          WorkerResources _val592;
          for (int _i593 = 0; _i593 < _map590.size; ++_i593)
          {
            _key591 = new NodeInfo();
            _key591.read(iprot);
            _val592 = new WorkerResources();
            _val592.read(iprot);
            struct.worker_resources.put(_key591, _val592);
          }
        }
        struct.set_worker_resources_isSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map594 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.device_resources = new HashMap<NodeInfo,Double>(2*_map594.size);
          NodeInfo _key595;
          double _val596;
          for (int _i597 = 0; _i597 < _map594.size; ++_i597)
          {
            _key595 = new NodeInfo();
            _key595.read(iprot);
            _val596 = iprot.readDouble();
            struct.device_resources.put(_key595, _val596);
          }
        }
        struct.set_device_resources_isSet(true);
      }
