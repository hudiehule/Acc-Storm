...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
  ...
  private static final org.apache.thrift.protocol.TField ACC_COMPONENT_EXECUTORS_FIELD_DESC = new org.apache.thrift.protocol.TField("acc_component_executors", org.apache.thrift.protocol.TType.MAP, (short)5);
  private static final org.apache.thrift.protocol.TField LAUNCH_TIME_SECS_FIELD_DESC = new org.apache.thrift.protocol.TField("launch_time_secs", org.apache.thrift.protocol.TType.I32, (short)6);
  ...
  private static final org.apache.thrift.protocol.TField TOPOLOGY_ACTION_OPTIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("topology_action_options", org.apache.thrift.protocol.TType.STRUCT, (short)8);
  private static final org.apache.thrift.protocol.TField PREV_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("prev_status", org.apache.thrift.protocol.TType.I32, (short)9);
  private static final org.apache.thrift.protocol.TField COMPONENT_DEBUG_FIELD_DESC = new org.apache.thrift.protocol.TField("component_debug", org.apache.thrift.protocol.TType.MAP, (short)10);
  ...
  public Map<String,Integer> acc_component_executors; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ACC_COMPONENT_EXECUTORS((short)5, "acc_component_executors"),
    LAUNCH_TIME_SECS((short)6, "launch_time_secs"),
    OWNER((short)7, "owner"),
    TOPOLOGY_ACTION_OPTIONS((short)8, "topology_action_options"),
    /**
     *
     * @see TopologyStatus
     */
    PREV_STATUS((short)9, "prev_status"),
    COMPONENT_DEBUG((short)10, "component_debug");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // ACC_COMPONENT_EXECUTORS
          return ACC_COMPONENT_EXECUTORS;
        case 6: // LAUNCH_TIME_SECS
          return LAUNCH_TIME_SECS;
        case 7: // OWNER
          return OWNER;
        case 8: // TOPOLOGY_ACTION_OPTIONS
          return TOPOLOGY_ACTION_OPTIONS;
        case 9: // PREV_STATUS
          return PREV_STATUS;
        case 10: // COMPONENT_DEBUG
  ...
  private static final _Fields optionals[] = {_Fields.COMPONENT_EXECUTORS,_Fields.ACC_COMPONENT_EXECUTORS,_Fields.LAUNCH_TIME_SECS,_Fields.OWNER,_Fields.TOPOLOGY_ACTION_OPTIONS,_Fields.PREV_STATUS,_Fields.COMPONENT_DEBUG};
  ...
  static {
    ...
    tmpMap.put(_Fields.COMPONENT_EXECUTORS, new org.apache.thrift.meta_data.FieldMetaData("component_executors", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP,
                    new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING),
                    new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
    tmpMap.put(_Fields.ACC_COMPONENT_EXECUTORS, new org.apache.thrift.meta_data.FieldMetaData("acc_component_executors", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP,
                    new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING),
                    new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
  ...
  public StormBase(StormBase other) {
    ...
    if (other.is_set_acc_component_executors()) {
      Map<String,Integer> __this__acc_component_executors = new HashMap<String,Integer>(other.acc_component_executors);
      this.acc_component_executors = __this__acc_component_executors;
    }
  ...
  public void clear() {
    ...
    this.acc_component_executors = null;
  ...
  public int get_acc_component_executors_size() {
    return (this.acc_component_executors == null) ? 0 : this.acc_component_executors.size();
  }

  public void put_to_acc_component_executors(String key, int val) {
    if (this.acc_component_executors == null) {
      this.acc_component_executors = new HashMap<String,Integer>();
    }
    this.acc_component_executors.put(key, val);
  }

  public Map<String,Integer> get_acc_component_executors() {
    return this.acc_component_executors;
  }

  public void set_acc_component_executors(Map<String,Integer> acc_component_executors) {
    this.acc_component_executors = acc_component_executors;
  }

  public void unset_acc_component_executors() {
    this.acc_component_executors = null;
  }

  /** Returns true if field acc_component_executors is set (has been assigned a value) and false otherwise */
  public boolean is_set_acc_component_executors() {
    return this.acc_component_executors != null;
  }

  public void set_acc_component_executors_isSet(boolean value) {
    if (!value) {
      this.acc_component_executors = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ACC_COMPONENT_EXECUTORS:
      if (value == null) {
        unset_acc_component_executors();
      } else {
        set_acc_component_executors((Map<String,Integer>)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ACC_COMPONENT_EXECUTORS:
      return get_acc_component_executors();
  ...
  public boolean isSet(_Fields field) {
    ...
    case ACC_COMPONENT_EXECUTORS:
      return is_set_acc_component_executors();
    case LAUNCH_TIME_SECS:
  ...
  public boolean equals(StormBase that) {
    ...
    boolean this_present_acc_component_executors = true && this.is_set_acc_component_executors();
    boolean that_present_acc_component_executors = true && that.is_set_acc_component_executors();
    if (this_present_acc_component_executors || that_present_acc_component_executors) {
      if (!(this_present_acc_component_executors && that_present_acc_component_executors))
        return false;
      if (!this.acc_component_executors.equals(that.acc_component_executors))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_acc_component_executors = true && (is_set_acc_component_executors());
    list.add(present_acc_component_executors);
    if (present_acc_component_executors)
      list.add(acc_component_executors);
  ...
  public int compareTo(StormBase other) {
    ...
    lastComparison = Boolean.valueOf(is_set_acc_component_executors()).compareTo(other.is_set_acc_component_executors());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_acc_component_executors()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.acc_component_executors, other.acc_component_executors);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (is_set_acc_component_executors()) {
      if (!first) sb.append(", ");
      sb.append("acc_component_executors:");
      if (this.acc_component_executors == null) {
        sb.append("null");
      } else {
        sb.append(this.acc_component_executors);
      }
      first = false;
    }
    if (is_set_launch_time_secs()) {
  ...
  private static class StormBaseStandardScheme extends StandardScheme<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.acc_component_executors = new HashMap<String,Integer>(2*_map618.size);
                String _key619;
                int _val620;
                for (int _i621 = 0; _i621 < _map618.size; ++_i621)
                {
                  ...
                  struct.acc_component_executors.put(_key619, _val620);
                }
                iprot.readMapEnd();
              }
              struct.set_acc_component_executors_isSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map622.size);
                String _key623;
                DebugOptions _val624;
                for (int _i625 = 0; _i625 < _map622.size; ++_i625)
                {
                  _key623 = iprot.readString();
                  _val624 = new DebugOptions();
                  _val624.read(iprot);
                  struct.component_debug.put(_key623, _val624);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter626 : struct.component_executors.entrySet())
            {
              oprot.writeString(_iter626.getKey());
              oprot.writeI32(_iter626.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.acc_component_executors != null) {
        if (struct.is_set_acc_component_executors()) {
          oprot.writeFieldBegin(ACC_COMPONENT_EXECUTORS_FIELD_DESC);
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, struct.acc_component_executors.size()));
            for (Map.Entry<String, Integer> _iter627 : struct.acc_component_executors.entrySet())
            {
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter628 : struct.component_debug.entrySet())
            {
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter629 : struct.component_executors.entrySet())
          {
            oprot.writeString(_iter629.getKey());
            oprot.writeI32(_iter629.getValue());
          }
        }
      }
      if (struct.is_set_acc_component_executors()) {
        {
          oprot.writeI32(struct.acc_component_executors.size());
          for (Map.Entry<String, Integer> _iter630 : struct.acc_component_executors.entrySet())
          {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (Map.Entry<String, DebugOptions> _iter631 : struct.component_debug.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_executors = new HashMap<String,Integer>(2*_map632.size);
          String _key633;
          int _val634;
          for (int _i635 = 0; _i635 < _map632.size; ++_i635)
          {
            ...
            struct.component_executors.put(_key633, _val634);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map636 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.acc_component_executors = new HashMap<String,Integer>(2*_map636.size);
          String _key637;
          int _val638;
          for (int _i639 = 0; _i639 < _map636.size; ++_i639)
          {
            ...
            struct.acc_component_executors.put(_key637, _val638);
          }
        }
        struct.set_acc_component_executors_isSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map640.size);
          String _key641;
          DebugOptions _val642;
          for (int _i643 = 0; _i643 < _map640.size; ++_i643)
          {
            _key641 = iprot.readString();
            _val642 = new DebugOptions();
            _val642.read(iprot);
            struct.component_debug.put(_key641, _val642);
          }
        }
        struct.set_component_debug_isSet(true);
      }
