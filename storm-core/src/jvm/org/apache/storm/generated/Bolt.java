...
public class Bolt implements org.apache.thrift.TBase<Bolt, Bolt._Fields>, java.io.Serializable, Cloneable, Comparable<Bolt> {
  ...
  private static final org.apache.thrift.protocol.TField IS_ACC_BOLT_FIELD_DESC = new org.apache.thrift.protocol.TField("isAccBolt", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  private static final int __ISACCBOLT_ISSET_ID = 0;
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_ACC_BOLT, new org.apache.thrift.meta_data.FieldMetaData("isAccBolt", org.apache.thrift.TFieldRequirementType.REQUIRED,
          ...
          boolean isAccBolt)
  {
    ...
    this.common = common;
    this.isAccBolt = isAccBolt;
    set_isAccBolt_isSet(true);
  }
  ...
  public Bolt(Bolt other) {
    ...
    this.isAccBolt = other.isAccBolt;
  }
  ...
  public void clear() {
    ...
    this.common = null;
    set_isAccBolt_isSet(false);
    this.isAccBolt = false;
  }
  ...
  public boolean is_isAccBolt() {
    return this.isAccBolt;
  }

  public Bolt set_isAccBolt(boolean isAccBolt) {
    this.isAccBolt = isAccBolt;
    set_isAccBolt_isSet(true);
    return this;
  }

  public void unset_isAccBolt() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISACCBOLT_ISSET_ID);
  }

  /** Returns true if field isAccBolt is set (has been assigned a value) and false otherwise */
  public boolean is_set_isAccBolt() {
    return EncodingUtils.testBit(__isset_bitfield, __ISACCBOLT_ISSET_ID);
  }

  public void set_isAccBolt_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISACCBOLT_ISSET_ID, value);
  }
  ...
  public boolean equals(Bolt that) {
    ...
    boolean this_present_isAccBolt = true;
    boolean that_present_isAccBolt = true;
    if (this_present_isAccBolt || that_present_isAccBolt) {
      if (!(this_present_isAccBolt && that_present_isAccBolt))
        return false;
      if (this.isAccBolt != that.isAccBolt)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_isAccBolt = true;
    list.add(present_isAccBolt);
    if (present_isAccBolt)
      list.add(isAccBolt);
  ...
  public int compareTo(Bolt other) {
    ...
    lastComparison = Boolean.valueOf(is_set_isAccBolt()).compareTo(other.is_set_isAccBolt());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_isAccBolt()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.isAccBolt, other.isAccBolt);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if(!is_set_isAccBolt()){
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'isAccBolt' was not present! Struct: " + toString());

    }
    // alas, we cannot check 'isAccBolt' because it's a primitive and you chose the non-beans generator.
  ...
  private static class BoltStandardScheme extends StandardScheme<Bolt> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Bolt struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 3: // IS_ACC_BOLT
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.isAccBolt = iprot.readBool();
              struct.set_isAccBolt_isSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
      ...
      /*if (!struct.isSetIsAccBolt()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'isAccBolt' was not found in serialized data! Struct: " + toString());
      }*/
      struct.validate();
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Bolt struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(IS_ACC_BOLT_FIELD_DESC);
      oprot.writeBool(struct.isAccBolt);
      oprot.writeFieldEnd();
