...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
  ...
  private static final org.apache.thrift.protocol.TField OCL_USED_FPGA_DEVICE_NUM_FIELD_DESC = new org.apache.thrift.protocol.TField("ocl_used_fpga_device_num", org.apache.thrift.protocol.TType.I32, (short)12);
  private static final org.apache.thrift.protocol.TField OCL_USED_GPU_DEVICE_NUM_FIELD_DESC = new org.apache.thrift.protocol.TField("ocl_used_gpu_device_num", org.apache.thrift.protocol.TType.I32, (short)13);
  ...
  public int ocl_used_fpga_device_num; // optional
  public int ocl_used_gpu_device_num; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    OCL_USED_FPGA_DEVICE_NUM((short)12, "ocl_used_fpga_device_num"),
    OCL_USED_GPU_DEVICE_NUM((short)13, "ocl_used_gpu_device_num");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 12: // OCL_USED_FPGA_DEVICE_NUM
          return OCL_USED_FPGA_DEVICE_NUM;
        case 13: // OCL_USED_GPU_DEVICE_NUM
          return OCL_USED_GPU_DEVICE_NUM;
        default:
          return null;
      }
    }
  ...
  private static final int __OCL_USED_FPGA_DEVICE_NUM_ISSET_ID = 4;
  private static final int __OCL_USED_GPU_DEVICE_NUM_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ASSIGNMENT_ID,_Fields.USED_PORTS,_Fields.META,_Fields.SCHEDULER_META,_Fields.UPTIME_SECS,_Fields.VERSION,_Fields.RESOURCES_MAP,_Fields.OCL_FPGA_DEVICE_NUM,_Fields.OCL_GPU_DEVICE_NUM,_Fields.OCL_USED_FPGA_DEVICE_NUM,_Fields.OCL_USED_GPU_DEVICE_NUM};
  ...
  static {
    ...
    tmpMap.put(_Fields.OCL_GPU_DEVICE_NUM, new org.apache.thrift.meta_data.FieldMetaData("ocl_gpu_device_num", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.OCL_USED_FPGA_DEVICE_NUM, new org.apache.thrift.meta_data.FieldMetaData("ocl_used_fpga_device_num", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.OCL_USED_GPU_DEVICE_NUM, new org.apache.thrift.meta_data.FieldMetaData("ocl_used_gpu_device_num", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public SupervisorInfo(SupervisorInfo other) {
    ...
    this.ocl_used_fpga_device_num = other.ocl_used_fpga_device_num;
    this.ocl_used_gpu_device_num = other.ocl_used_gpu_device_num;
  }
  ...
  public void clear() {
    ...
    set_ocl_fpga_device_num_isSet(false);
    this.ocl_fpga_device_num = 0;
    set_ocl_gpu_device_num_isSet(false);
    this.ocl_gpu_device_num = 0;
    set_ocl_used_fpga_device_num_isSet(false);
    this.ocl_used_fpga_device_num = 0;
    set_ocl_used_gpu_device_num_isSet(false);
    this.ocl_used_gpu_device_num = 0;
  }
  ...
  public int get_ocl_fpga_device_num() {
    return this.ocl_fpga_device_num;
  }

  public void set_ocl_fpga_device_num(int ocl_fpga_device_num) {
    this.ocl_fpga_device_num = ocl_fpga_device_num;
    set_ocl_fpga_device_num_isSet(true);
  }

  public void unset_ocl_fpga_device_num() {
  ...
  public boolean is_set_ocl_fpga_device_num() {
    return EncodingUtils.testBit(__isset_bitfield, __OCL_FPGA_DEVICE_NUM_ISSET_ID);
  }

  public void set_ocl_fpga_device_num_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __OCL_FPGA_DEVICE_NUM_ISSET_ID, value);
  }

  public int get_ocl_gpu_device_num() {
    return this.ocl_gpu_device_num;
  }

  public void set_ocl_gpu_device_num(int ocl_gpu_device_num) {
    this.ocl_gpu_device_num = ocl_gpu_device_num;
    set_ocl_gpu_device_num_isSet(true);
  }

  public void unset_ocl_gpu_device_num() {
  ...
  public boolean is_set_ocl_gpu_device_num() {
    return EncodingUtils.testBit(__isset_bitfield, __OCL_GPU_DEVICE_NUM_ISSET_ID);
  }

  public void set_ocl_gpu_device_num_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __OCL_GPU_DEVICE_NUM_ISSET_ID, value);
  }

  public int get_ocl_used_fpga_device_num() {
    return this.ocl_used_fpga_device_num;
  }

  public void set_ocl_used_fpga_device_num(int ocl_used_fpga_device_num) {
    this.ocl_used_fpga_device_num = ocl_used_fpga_device_num;
    set_ocl_used_fpga_device_num_isSet(true);
  }

  public void unset_ocl_used_fpga_device_num() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __OCL_USED_FPGA_DEVICE_NUM_ISSET_ID);
  }

  /** Returns true if field ocl_used_fpga_device_num is set (has been assigned a value) and false otherwise */
  public boolean is_set_ocl_used_fpga_device_num() {
    return EncodingUtils.testBit(__isset_bitfield, __OCL_USED_FPGA_DEVICE_NUM_ISSET_ID);
  }

  public void set_ocl_used_fpga_device_num_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __OCL_USED_FPGA_DEVICE_NUM_ISSET_ID, value);
  }

  public int get_ocl_used_gpu_device_num() {
    return this.ocl_used_gpu_device_num;
  }

  public void set_ocl_used_gpu_device_num(int ocl_used_gpu_device_num) {
    this.ocl_used_gpu_device_num = ocl_used_gpu_device_num;
    set_ocl_used_gpu_device_num_isSet(true);
  }

  public void unset_ocl_used_gpu_device_num() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __OCL_USED_GPU_DEVICE_NUM_ISSET_ID);
  }

  /** Returns true if field ocl_used_gpu_device_num is set (has been assigned a value) and false otherwise */
  public boolean is_set_ocl_used_gpu_device_num() {
    return EncodingUtils.testBit(__isset_bitfield, __OCL_USED_GPU_DEVICE_NUM_ISSET_ID);
  }

  public void set_ocl_used_gpu_device_num_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __OCL_USED_GPU_DEVICE_NUM_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case OCL_FPGA_DEVICE_NUM:
      if (value == null) {
        unset_ocl_fpga_device_num();
      } else {
        set_ocl_fpga_device_num((Integer)value);
      }
      break;

    case OCL_GPU_DEVICE_NUM:
      if (value == null) {
        unset_ocl_gpu_device_num();
      } else {
        set_ocl_gpu_device_num((Integer)value);
      }
      break;
      case OCL_USED_FPGA_DEVICE_NUM:
        if (value == null) {
          unset_ocl_used_fpga_device_num();
        } else {
          set_ocl_used_fpga_device_num((Integer)value);
        }
        break;

      case OCL_USED_GPU_DEVICE_NUM:
        if (value == null) {
          unset_ocl_used_gpu_device_num();
        } else {
          set_ocl_used_gpu_device_num((Integer)value);
        }
        break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case OCL_FPGA_DEVICE_NUM:
      return get_ocl_fpga_device_num();

    case OCL_GPU_DEVICE_NUM:
      return get_ocl_gpu_device_num();

    case OCL_USED_FPGA_DEVICE_NUM:
      return get_ocl_used_fpga_device_num();

    case OCL_USED_GPU_DEVICE_NUM:
      return get_ocl_used_gpu_device_num();
    }
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
      ...
      case OCL_FPGA_DEVICE_NUM:
        return is_set_ocl_fpga_device_num();
      case OCL_GPU_DEVICE_NUM:
        return is_set_ocl_gpu_device_num();
      case OCL_USED_FPGA_DEVICE_NUM:
        return is_set_ocl_used_fpga_device_num();
      case OCL_USED_GPU_DEVICE_NUM:
        return is_set_ocl_used_gpu_device_num();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(SupervisorInfo that) {
    ...
    boolean this_present_ocl_fpga_device_num = true && this.is_set_ocl_fpga_device_num();
    boolean that_present_ocl_fpga_device_num = true && that.is_set_ocl_fpga_device_num();
    ...
    boolean this_present_ocl_gpu_device_num = true && this.is_set_ocl_gpu_device_num();
    boolean that_present_ocl_gpu_device_num = true && that.is_set_ocl_gpu_device_num();
    ...
    boolean this_present_ocl_used_fpga_device_num = true && this.is_set_ocl_used_fpga_device_num();
    boolean that_present_ocl_used_fpga_device_num = true && that.is_set_ocl_used_fpga_device_num();
    if (this_present_ocl_used_fpga_device_num || that_present_ocl_used_fpga_device_num) {
      if (!(this_present_ocl_used_fpga_device_num && that_present_ocl_used_fpga_device_num))
        return false;
      if (this.ocl_used_fpga_device_num != that.ocl_used_fpga_device_num)
        return false;
    }

    boolean this_present_ocl_used_gpu_device_num = true && this.is_set_ocl_used_gpu_device_num();
    boolean that_present_ocl_used_gpu_device_num = true && that.is_set_ocl_used_gpu_device_num();
    if (this_present_ocl_used_gpu_device_num || that_present_ocl_used_gpu_device_num) {
      if (!(this_present_ocl_used_gpu_device_num && that_present_ocl_used_gpu_device_num))
        return false;
      if (this.ocl_used_gpu_device_num != that.ocl_used_gpu_device_num)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_ocl_fpga_device_num = true && (is_set_ocl_fpga_device_num());
    list.add(present_ocl_fpga_device_num);
    if (present_ocl_fpga_device_num)
      list.add(ocl_fpga_device_num);

    boolean present_ocl_gpu_device_num = true && (is_set_ocl_gpu_device_num());
    list.add(present_ocl_gpu_device_num);
    if (present_ocl_gpu_device_num)
      list.add(ocl_gpu_device_num);

    boolean present_ocl_used_fpga_device_num = true && (is_set_ocl_used_fpga_device_num());
    list.add(present_ocl_used_fpga_device_num);
    if (present_ocl_used_fpga_device_num)
      list.add(ocl_used_fpga_device_num);

    boolean present_ocl_used_gpu_device_num = true && (is_set_ocl_used_gpu_device_num());
    list.add(present_ocl_used_gpu_device_num);
    if (present_ocl_used_gpu_device_num)
      list.add(ocl_used_gpu_device_num);
  ...
  public int compareTo(SupervisorInfo other) {
    ...
    lastComparison = Boolean.valueOf(is_set_ocl_fpga_device_num()).compareTo(other.is_set_ocl_fpga_device_num());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_ocl_fpga_device_num()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ocl_fpga_device_num, other.ocl_fpga_device_num);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_ocl_gpu_device_num()).compareTo(other.is_set_ocl_gpu_device_num());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_ocl_gpu_device_num()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ocl_gpu_device_num, other.ocl_gpu_device_num);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_ocl_used_fpga_device_num()).compareTo(other.is_set_ocl_used_fpga_device_num());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_ocl_used_fpga_device_num()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ocl_used_fpga_device_num, other.ocl_used_fpga_device_num);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_ocl_used_gpu_device_num()).compareTo(other.is_set_ocl_used_gpu_device_num());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_ocl_used_gpu_device_num()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ocl_used_gpu_device_num, other.ocl_used_gpu_device_num);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (is_set_ocl_used_fpga_device_num()) {
      if (!first) sb.append(", ");
      sb.append("ocl_used_fpga_device_num:");
      sb.append(this.ocl_used_fpga_device_num);
      first = false;
    }
    if (is_set_ocl_used_gpu_device_num()) {
      if (!first) sb.append(", ");
      sb.append("ocl_used_gpu_device_num:");
      sb.append(this.ocl_used_gpu_device_num);
      first = false;
    }
    sb.append(")");
    return sb.toString();
        ...
        switch (schemeField.id) {
          ...
          case 10: // OCL_FPGA_DEVICE_NUM
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              ...
              struct.set_ocl_fpga_device_num_isSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 11: // OCL_GPU_DEVICE_NUM
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              ...
              struct.set_ocl_gpu_device_num_isSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 12: // OCL_USED_FPGA_DEVICE_NUM
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.ocl_used_fpga_device_num = iprot.readI32();
              struct.set_ocl_used_fpga_device_num_isSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 13: // OCL_USED_GPU_DEVICE_NUM
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.ocl_used_gpu_device_num = iprot.readI32();
              struct.set_ocl_used_gpu_device_num_isSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
...
/*
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.is_set_ocl_fpga_device_num()) {
        oprot.writeFieldBegin(OCL_FPGA_DEVICE_NUM_FIELD_DESC);
        oprot.writeI32(struct.ocl_fpga_device_num);
        oprot.writeFieldEnd();
      }
      if (struct.is_set_ocl_gpu_device_num()) {
        oprot.writeFieldBegin(OCL_GPU_DEVICE_NUM_FIELD_DESC);
        oprot.writeI32(struct.ocl_gpu_device_num);
        oprot.writeFieldEnd();
      }
      if (struct.is_set_ocl_used_fpga_device_num()) {
        oprot.writeFieldBegin(OCL_USED_FPGA_DEVICE_NUM_FIELD_DESC);
        oprot.writeI32(struct.ocl_used_fpga_device_num);
        oprot.writeFieldEnd();
      }
      if (struct.is_set_ocl_used_gpu_device_num()) {
        oprot.writeFieldBegin(OCL_USED_GPU_DEVICE_NUM_FIELD_DESC);
        oprot.writeI32(struct.ocl_used_gpu_device_num);
        oprot.writeFieldEnd();
      }
