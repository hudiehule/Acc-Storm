...
public class TopologyPageInfo implements org.apache.thrift.TBase<TopologyPageInfo, TopologyPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyPageInfo> {
  ...
  private static final org.apache.thrift.protocol.TField ASSIGNED_FPGA_DEVICES_FIELD_DESC = new org.apache.thrift.protocol.TField("assigned_fpga_devices", org.apache.thrift.protocol.TType.DOUBLE, (short)527);
  private static final org.apache.thrift.protocol.TField ASSIGNED_GPU_DEVICES_FIELD_DESC = new org.apache.thrift.protocol.TField("assigned_gpu_devices", org.apache.thrift.protocol.TType.DOUBLE, (short)528);
  ...
  public double assigned_fpga_devices; // optional
  public double assigned_gpu_devices; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ASSIGNED_FPGA_DEVICES((short)527, "assigned_fpga_devices"),
    ASSIGNED_GPU_DEVICES((short)528, "assigned_gpu_devices");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 526: // ASSIGNED_CPU
          return ASSIGNED_CPU;
        case 527: // ASSIGNED_FPGA_DEVICES
          return ASSIGNED_FPGA_DEVICES;
        case 528: // ASSIGNED_GPU_DEVICES
          return ASSIGNED_GPU_DEVICES;
        default:
          return null;
      }
    }
  ...
  private static final int __ASSIGNED_FPGA_DEVICES_ISSET_ID = 11;
  private static final int __ASSIGNED_GPU_DEVICES_ISSET_ID = 12;
  private short __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.UPTIME_SECS,_Fields.STATUS,_Fields.NUM_TASKS,_Fields.NUM_WORKERS,_Fields.NUM_EXECUTORS,_Fields.TOPOLOGY_CONF,_Fields.ID_TO_SPOUT_AGG_STATS,_Fields.ID_TO_BOLT_AGG_STATS,_Fields.SCHED_STATUS,_Fields.TOPOLOGY_STATS,_Fields.OWNER,_Fields.DEBUG_OPTIONS,_Fields.REPLICATION_COUNT,_Fields.REQUESTED_MEMONHEAP,_Fields.REQUESTED_MEMOFFHEAP,_Fields.REQUESTED_CPU,_Fields.ASSIGNED_MEMONHEAP,_Fields.ASSIGNED_MEMOFFHEAP,_Fields.ASSIGNED_CPU,_Fields.ASSIGNED_FPGA_DEVICES,_Fields.ASSIGNED_GPU_DEVICES};
  ...
  static {
    ...
    tmpMap.put(_Fields.ASSIGNED_CPU, new org.apache.thrift.meta_data.FieldMetaData("assigned_cpu", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    tmpMap.put(_Fields.ASSIGNED_FPGA_DEVICES, new org.apache.thrift.meta_data.FieldMetaData("assigned_fpga_devices", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    tmpMap.put(_Fields.ASSIGNED_GPU_DEVICES, new org.apache.thrift.meta_data.FieldMetaData("assigned_gpu_devices", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
  ...
  public TopologyPageInfo(TopologyPageInfo other) {
    ...
    this.assigned_fpga_devices = other.assigned_fpga_devices;
    this.assigned_gpu_devices = other.assigned_gpu_devices;
  }
  ...
  public void clear() {
    ...
    set_assigned_fpga_devices_isSet(false);
    this.assigned_fpga_devices = 0.0;
    set_assigned_gpu_devices_isSet(false);
    this.assigned_gpu_devices = 0.0;
  }
  ...
  public double get_assigned_fpga_devices() {
    return this.assigned_fpga_devices;
  }

  public TopologyPageInfo set_assigned_fpga_devices(double assigned_fpga_devices) {
    this.assigned_fpga_devices = assigned_fpga_devices;
    set_assigned_fpga_devices_isSet(true);
    return this;
  }

  public void unset_assigned_fpga_devices() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ASSIGNED_FPGA_DEVICES_ISSET_ID);
  }

  /** Returns true if field assigned_fpga_devices is set (has been assigned a value) and false otherwise */
  public boolean is_set_assigned_fpga_devices() {
    return EncodingUtils.testBit(__isset_bitfield, __ASSIGNED_FPGA_DEVICES_ISSET_ID);
  }

  public void set_assigned_fpga_devices_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ASSIGNED_FPGA_DEVICES_ISSET_ID, value);
  }

  public double get_assigned_gpu_devices() {
    return this.assigned_gpu_devices;
  }

  public TopologyPageInfo set_assigned_gpu_devices(double assigned_gpu_devices) {
    this.assigned_gpu_devices = assigned_gpu_devices;
    set_assigned_gpu_devices_isSet(true);
    return this;
  }

  public void unset_assigned_gpu_devices() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ASSIGNED_GPU_DEVICES_ISSET_ID);
  }

  /** Returns true if field assigned_gpu_devices is set (has been assigned a value) and false otherwise */
  public boolean is_set_assigned_gpu_devices() {
    return EncodingUtils.testBit(__isset_bitfield, __ASSIGNED_GPU_DEVICES_ISSET_ID);
  }

  public void set_assigned_gpu_devices_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ASSIGNED_GPU_DEVICES_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
      ...
      case ASSIGNED_FPGA_DEVICES:
        if (value == null) {
          unset_assigned_fpga_devices();
        } else {
          set_assigned_fpga_devices((Double)value);
        }
        break;

      case ASSIGNED_GPU_DEVICES:
        if (value == null) {
          unset_assigned_gpu_devices();
        } else {
          set_assigned_gpu_devices((Double)value);
        }
        break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
      ...
      case ASSIGNED_FPGA_DEVICES:
        return get_assigned_fpga_devices();

      case ASSIGNED_GPU_DEVICES:
        return get_assigned_gpu_devices();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
      ...
      case ASSIGNED_FPGA_DEVICES:
        return is_set_assigned_fpga_devices();
      case ASSIGNED_GPU_DEVICES:
        return is_set_assigned_gpu_devices();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(TopologyPageInfo that) {
    ...
    boolean this_present_assigned_fpga_devices = true && this.is_set_assigned_fpga_devices();
    boolean that_present_assigned_fpga_devices = true && that.is_set_assigned_fpga_devices();
    if (this_present_assigned_fpga_devices || that_present_assigned_fpga_devices) {
      if (!(this_present_assigned_fpga_devices && that_present_assigned_fpga_devices))
        return false;
      if (this.assigned_fpga_devices != that.assigned_fpga_devices)
        return false;
    }

    boolean this_present_assigned_gpu_devices = true && this.is_set_assigned_gpu_devices();
    boolean that_present_assigned_gpu_devices = true && that.is_set_assigned_gpu_devices();
    if (this_present_assigned_gpu_devices || that_present_assigned_gpu_devices) {
      if (!(this_present_assigned_gpu_devices && that_present_assigned_gpu_devices))
        return false;
      if (this.assigned_gpu_devices != that.assigned_gpu_devices)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_assigned_fpga_devices = true && (is_set_assigned_fpga_devices());
    list.add(present_assigned_fpga_devices);
    if (present_assigned_fpga_devices)
      list.add(assigned_fpga_devices);

    boolean present_assigned_gpu_devices = true && (is_set_assigned_gpu_devices());
    list.add(present_assigned_gpu_devices);
    if (present_assigned_gpu_devices)
      list.add(assigned_gpu_devices);
  ...
  public int compareTo(TopologyPageInfo other) {
    ...
    lastComparison = Boolean.valueOf(is_set_assigned_fpga_devices()).compareTo(other.is_set_assigned_fpga_devices());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_assigned_fpga_devices()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.assigned_fpga_devices, other.assigned_fpga_devices);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_assigned_gpu_devices()).compareTo(other.is_set_assigned_gpu_devices());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_assigned_gpu_devices()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.assigned_gpu_devices, other.assigned_gpu_devices);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (is_set_assigned_fpga_devices()) {
      if (!first) sb.append(", ");
      sb.append("assigned_fpga_devices:");
      sb.append(this.assigned_fpga_devices);
      first = false;
    }
    if (is_set_assigned_gpu_devices()) {
      if (!first) sb.append(", ");
      sb.append("assigned_gpu_devices:");
      sb.append(this.assigned_gpu_devices);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TopologyPageInfoStandardScheme extends StandardScheme<TopologyPageInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TopologyPageInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 527: // ASSIGNED_FPGA_DEVICES
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.assigned_fpga_devices = iprot.readDouble();
              struct.set_assigned_fpga_devices_isSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 528: // ASSIGNED_GPU_DEVICES
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.assigned_gpu_devices = iprot.readDouble();
              struct.set_assigned_gpu_devices_isSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.is_set_assigned_fpga_devices()) {
        oprot.writeFieldBegin(ASSIGNED_FPGA_DEVICES_FIELD_DESC);
        oprot.writeDouble(struct.assigned_fpga_devices);
        oprot.writeFieldEnd();
      }
      if (struct.is_set_assigned_gpu_devices()) {
        oprot.writeFieldBegin(ASSIGNED_GPU_DEVICES_FIELD_DESC);
        oprot.writeDouble(struct.assigned_gpu_devices);
        oprot.writeFieldEnd();
      }
